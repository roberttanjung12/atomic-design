...
import UserPage from '@/app/(main)/setting/user/page';
...
describe('UserPage Component', () => {
  it('renders PageID with the correct title and breadcrumbs', () => {
    ...
    expect(titleElement).toHaveTextContent('Users');
    ...
    expect(breadcrumbLinks[1]).toHaveTextContent('Users');
  ...
  it('renders children content correctly', () => {
    ...
    expect(within(childrenContainer).getByText('Users')).toBeInTheDocument();
  });
});
