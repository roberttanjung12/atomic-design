 ...
 * @param {(event: React.ChangeEvent<HTMLInputElement>, value: boolean) => void} props.onChange - Callback fired when the radio state changes.
 ...
 */
const RadioButton = ({ options, value, onChange, slotProps }: RadioButtonProps) => {
